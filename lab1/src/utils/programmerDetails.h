...
{
    constexpr const char* const FIRSTNAME = "Krzysztof";
    constexpr const char* const SURNAME   = "Siekierzyński";

    constexpr const char* const MAIL    = "ksiek[at]student.agh.edu.pl";
    constexpr const char* const BOOK_ID = "400411";
